...
uniform float _texture_normal_depth_array[256];
uniform float _texture_ao_strength_array[256];
uniform float _texture_roughness_mod_array[25];
uniform float _texture_uv_scale_array[256];
uniform vec2 _texture_detile_array[256];
uniform vec4 _texture_color_array[256];
